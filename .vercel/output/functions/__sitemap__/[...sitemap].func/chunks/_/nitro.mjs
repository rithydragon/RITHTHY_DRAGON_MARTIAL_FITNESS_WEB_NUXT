...
const _assets = {
  ["i18n:539e4840.json"]: {
    import: () => import('../raw/539e4840.mjs').then(r => r.default || r),
    meta: {"type":"application/json","etag":"\"1ac8-arvVzNDeSMhrE6V9os5t195pjLc\"","mtime":"2026-09-17T15:03:25.027Z"}
  },
  ["i18n:64634f74.json"]: {
    import: () => import('../raw/64634f74.mjs').then(r => r.default || r),
    meta: {"type":"application/json","etag":"\"184d-IP5o5XPNgGVSYXZFCPg/QE1/FR8\"","mtime":"2026-09-17T15:03:25.036Z"}
  },
  ["i18n:e0401de7.json"]: {
    import: () => import('../raw/e0401de7.mjs').then(r => r.default || r),
    meta: {"type":"application/json","etag":"\"3890-YVP2bfjuR8CNvUfXnerA0aCHfHc\"","mtime":"2026-09-17T15:03:25.027Z"}
  }
};
...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "b0813aac-2da7-4b5f-88c9-596efa79dd71",
  ...
  "nitro": {
    ...
    "routeRules": {
      ...
      "/_riththy_dragon/builds/meta/**": {
        "headers": {
          "cache-control": "public, max-age=31536000, immutable"
        }
      },
      "/_riththy_dragon/builds/**": {
        "headers": {
  ...
  "public": {
    "telegramClientId": "8625305714",
    "wsBase": "wss://localhost:58721/ws",
    "i18n": {
      "baseUrl": "",
      "defaultLocale": "en",
      "rootRedirect": "",
    ...
    "nuxt-robots": {
      ...
      "groups": [
        {
          ...
          "_rules": [
            ...
            {
              "pattern": "/km/dashboard/",
              "allow": false
            },
            {
              "pattern": "/zh/dashboard/",
              "allow": false
            },
            {
              "pattern": "/api/",
      ...
      "sitemap": [
        "https://rithymartialfitness.com/sitemap.xml",
        "/sitemap_index.xml"
      ],
      "header": true,
  ...
  "apiInternalSecret": "change-me",
  "apiBase": "http:/localhost:58721",
  "siteUrl": "https://rithymartial.com",
  "oauth": {
    "googleClientId": "DSG",
    "facebookAppId": "DSG",
    "tiktokClientKey": "DFG",
    "telegramBotName": "RithyMartialBot"
  },
  "telegramClientId": "8625305714",
  "telegramClientSecret": "elb7_BB_0nIlLaAUo2cx3qA7x--wN_U3ZD-_tMMzrLNI3UA9m5MK2Q",
  "sessionSecret": "",
  "sitemap": {
...
const _iMACpZqT9L5hvtF2ofnX5CqmCXMeEtW5XRgV6QpK4 = defineNitroPlugin(async (nitroApp) => {
...
const _grn2hPLSW1fVfyJzrtvpOAVknAZhjKLL4wP0X_NvUzE = defineNitroPlugin(async (nitroApp) => {
...
const localeLoaders = {
  en: [
    {
      key: "locale_en_46json_539e4840",
      load: () => readI18nAsset("539e4840.json"),
      cache: true
    }
  ],
  km: [
    {
      key: "locale_km_46json_e0401de7",
      load: () => readI18nAsset("e0401de7.json"),
      cache: true
    }
  ],
  zh: [
    {
      key: "locale_zh_46json_64634f74",
      load: () => readI18nAsset("64634f74.json"),
      cache: true
    }
  ]
};
...
const appRootTag = "riththy-main";

const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"theme-color","content":"#0a0a0a"},{"name":"description","content":"Premium fitness training in Cambodia led by Mr. Ny Rithy. Strength & conditioning, private and group classes."},{"name":"keywords","content":"Fitness training Cambodia, Ny Rithy,RITHTHY Fitness"},{"property":"og:type","content":"website"},{"property":"og:title","content":"RITHTHY Fitness — Premier Fitness Training"},{"property":"og:description","content":"Train with high-performance athletic conditioning with Master Ny Rithy."},{"property":"og:locale","content":"en_US"},{"property":"og:image","content":"/og-image.jpg"},{"property":"og:url","content":"https://rithymartialfitness.com"},{"name":"twitter:card","content":"summary_large_image"},{"name":"twitter:title","content":"RITHTHY Fitness"},{"name":"twitter:description","content":"Strength Conditioning in Phnom Penh."},{"name":"twitter:image","content":"/og-image.jpg"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"},{"rel":"preconnect","href":"https://fonts.googleapis.com"},{"rel":"preconnect","href":"https://fonts.gstatic.com","crossorigin":""},{"rel":"stylesheet","href":"https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&family=Noto+Sans+Khmer:wght@400;500;700&family=Noto+Serif+Khmer:wght@400;600;700&display=swap"},{"rel":"stylesheet","href":"https://cdn.jsdelivr.net/npm/remixicon@4.9.1/fonts/remixicon.min.css"}],"style":[],"script":[{"innerHTML":"(function(){try{var t=localStorage.getItem('rmf-theme');var d='dark';if(t==='light'){d='light'}else if(t==='system'){d=(window.matchMedia&&window.matchMedia('(prefers-color-scheme: light)').matches)?'light':'dark'}}catch(e){}var r=document.documentElement;r.classList.add(d);r.setAttribute('data-theme',d)})()"}],"noscript":[],"htmlAttrs":{"lang":"en","dir":"ltr"},"title":"RITHTHY Fitness — Premier Fitness Training","bodyAttrs":{"class":"riththy-dragon-fitness"}};

const appRootAttrs = {"id":"riththy"};
...
const _lT0U5jheXpnXutOYExb8Mc0NYucnpBpggaAFOpIXFE = defineNitroPlugin(async (nitro) => {
  const runtimeI18n = useRuntimeI18n();
...
const plugins = [
  _iMACpZqT9L5hvtF2ofnX5CqmCXMeEtW5XRgV6QpK4,
_grn2hPLSW1fVfyJzrtvpOAVknAZhjKLL4wP0X_NvUzE,
_lT0U5jheXpnXutOYExb8Mc0NYucnpBpggaAFOpIXFE
];

const PORT_SUFFIX_RE = /:\d+$/;
const _GzcHVR = eventHandler(async (e) => {
...
const staticConfig = {"isI18nMapped":true,"sitemapName":"sitemap.xml","isMultiSitemap":true,"excludeAppSources":[],"cacheMaxAgeSeconds":600,"experimentalStreaming":false,"autoLastmod":false,"defaultSitemapsChunkSize":1000,"minify":false,"sortEntries":true,"discoverImages":true,"discoverVideos":true,"sitemapsPathPrefix":"/__sitemap__/","isNuxtContentDocumentDriven":false,"xsl":"/__sitemap__/style.xsl","xslTips":true,"xslColumns":[{"label":"URL","width":"50%"},{"label":"Images","width":"25%","select":"count(image:image)"},{"label":"Last Updated","width":"25%","select":"concat(substring(sitemap:lastmod,0,11),concat(' ', substring(sitemap:lastmod,12,5)),concat(' ', substring(sitemap:lastmod,20,6)))"}],"credits":true,"version":"8.3.0","sitemaps":{"index":{"sitemapName":"index","_route":"sitemap_index.xml","sitemaps":[],"include":[],"exclude":[]},"English":{"include":[],"exclude":["/_**","_riththy_dragon/**","/km_riththy_dragon/**","/zh_riththy_dragon/**"],"includeAppSources":true,"sitemapName":"English","_route":"/__sitemap__/English.xml"},"Khmer":{"include":[],"exclude":["/_**","_riththy_dragon/**","/km_riththy_dragon/**","/zh_riththy_dragon/**"],"includeAppSources":true,"sitemapName":"Khmer","_route":"/__sitemap__/Khmer.xml"},"Chinese":{"include":[],"exclude":["/_**","_riththy_dragon/**","/km_riththy_dragon/**","/zh_riththy_dragon/**"],"includeAppSources":true,"sitemapName":"Chinese","_route":"/__sitemap__/Chinese.xml"}},"autoI18n":{"differentDomains":false,"defaultLocale":"en","locales":[{"code":"en","iso":"en-US","name":"English","language":"English","file":"en.json","isotime":"En","flag":"/flags/gb.svg","_hreflang":"English","_sitemap":"English"},{"code":"km","iso":"km-KH","name":"ខ្មែរ","language":"Khmer","file":"km.json","isotime":"Kh","flag":"/flags/kh.svg","_hreflang":"Khmer","_sitemap":"Khmer"},{"code":"zh","iso":"zh-CN","name":"中文","language":"Chinese","file":"zh.json","isotime":"Ch","flag":"/flags/zh.svg","_hreflang":"Chinese","_sitemap":"Chinese"}],"strategy":"prefix_except_default","pages":{}}};
...
const _CMYvtk = defineEventHandler(async (e) => {
...
function* renderSitemapXmlChunks(urls, resolvers, { version, xsl, credits, minify }, errorInfo) {
...
function* renderSitemapIndexXmlChunks(sitemaps, resolvers, { version, xsl, credits, minify }, errorInfo) {
  const NL = minify ? "" : "\n";
  const I1 = minify ? "" : "    ";
  const I2 = minify ? "" : "        ";
...
function urlsToIndexXmlStream(sitemaps, resolvers, config, errorInfo) {
...
async function sitemapIndexXmlEventHandler(e) {
  ...
  const output = await renderSitemapOutput(
    ...
    !!runtimeConfig.experimentalStreaming && true,
    runtimeConfig.debug
  );
...
const _oRTe5_ = defineEventHandler(sitemapXmlEventHandler);

const _F9DaIH = defineEventHandler(async (e) => {
  const nitroApp = useNitroApp();
...
const _NJi2Fv = defineEventHandler(async (e) => {
...
const _AdyhX8 = _messagesHandlerCached;

const _SxA8c9 = defineEventHandler(() => {});

const _lazy_oy9pYS = () => import('../routes/renderer.mjs');
const _lazy_1SfYDF = () => import('../routes/sitemap_index.xml.mjs');
const _lazy_t1dtAZ = () => import('../routes/__sitemap__/_sitemap_.xml.mjs');

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_oy9pYS, lazy: true, middleware: false, method: undefined },
  { route: '', handler: _GzcHVR, lazy: false, middleware: true, method: undefined },
  { route: '/sitemap_index.xml', handler: _lazy_1SfYDF, lazy: true, middleware: false, method: undefined },
  { route: '/__sitemap__/**:sitemap', handler: _lazy_t1dtAZ, lazy: true, middleware: false, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _CMYvtk, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _oRTe5_, lazy: false, middleware: false, method: undefined },
  { route: '/robots.txt', handler: _F9DaIH, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _NJi2Fv, lazy: false, middleware: true, method: undefined },
  { route: '/_i18n/:hash/:locale/messages.json', handler: _AdyhX8, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_oy9pYS, lazy: true, middleware: false, method: undefined }
];
...
export { sitemapChildXmlEventHandler as A, publicAssetsURL as a, buildAssetsURL as b, appRootTag as c, appRootAttrs as d, appSpaLoaderTag as e, appSpaLoaderAttrs as f, getRouteRulesForPath as g, useRuntimeConfig as h, appId as i, encodePath as j, defineRenderHandler as k, appTeleportTag as l, appTeleportAttrs as m, getQuery as n, createError$1 as o, parseQuery as p, appHead as q, destr as r, getRouteRules as s, toNodeListener as t, useNitroApp as u, getResponseStatusText as v, withQuery as w, getResponseStatus as x, defineEventHandler as y, sitemapIndexXmlEventHandler as z };
